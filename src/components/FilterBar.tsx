...
export const FilterBar = ({ bulan, tahun, onBulanChange, onTahunChange }: FilterBarProps) => {
  return (
    <div className="flex flex-wrap items-center gap-4 bg-white p-2 rounded-xl">
      ...
      <div className="flex gap-2">
        <select
          ...
          className="px-4 py-2 bg-slate-50 border border-slate-100 rounded-xl focus:outline-none focus:ring-4 focus:ring-indigo-500/10 focus:border-indigo-500 transition-all text-xs font-black uppercase tracking-wider text-slate-700 appearance-none cursor-pointer"
        >
          {BULAN_LIST.map((b) => (
