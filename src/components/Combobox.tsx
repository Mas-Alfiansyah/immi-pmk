  ...
  return (
    <div className="relative" ref={containerRef}>
      <div 
        ...
        className={`w-full px-6 py-4 rounded-xl bg-slate-50 border border-slate-100 cursor-pointer flex items-center justify-between group transition-all ${isOpen ? 'ring-4 ring-primary-500/10 border-primary-500' : ''}`}
      >
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="absolute z-[60] left-0 right-0 mt-2 bg-white rounded-xl shadow-2xl border border-slate-100 overflow-hidden"
          >
              ...
              {filteredOptions.length > 0 ? (
                filteredOptions.map((opt) => (
                  <div
                    ...
                    className={`px-4 py-3 rounded-xl cursor-pointer font-bold text-sm transition-colors ${
